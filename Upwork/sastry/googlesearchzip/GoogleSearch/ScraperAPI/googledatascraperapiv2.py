    ...
    def start_requests(self):
        with open('input.txt') as file:
            ...
            for input in inputs:
                ...
                yield scrapy.FormRequest(self.client.scrapyGet(url=link), callback=self.parse, meta={'count': count, 'input': input})
...
execute(f'scrapy runspider googledatascraperapiv2.py'.split())