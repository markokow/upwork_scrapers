...
class PAA_Scraper:
    ...
    def fetch(self):
        ...
        response = requests.get(f"https://www.google.com/search?q='+{self.keyword}", headers = self.headers, proxies=self.proxyDict)
    ...
    def write_csv(self, file_name: str = ''):
        ...
        print(f"Saved to {file_name}.xlsx")
    ...
    def run(self):
        ...
        self.proxyDict['https'] = f"https://{str(_ip)}:8080"
