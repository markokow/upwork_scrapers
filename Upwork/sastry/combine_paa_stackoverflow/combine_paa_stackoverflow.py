...
class CombinedPaa_Stackoverflow:

    def __init__(self, *,max_stack: int = 3 , max_paa: int = 4, max_divisions: int = 3) -> None:
    ...
    def run(self):
        ...
        df = pd.read_csv("stackoverflow-keywords.csv", engine='python')
...
if __name__ == '__main__':
    ...
    #Run scraper
    scraper = CombinedPaa_Stackoverflow(max_stack = max_stack, max_paa = max_paa, max_divisions = max_divisions)
    scraper.run()