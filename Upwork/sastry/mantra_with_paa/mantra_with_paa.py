...
class CombinedPaa_Mantra:
    ...
    def parse(self, *, html) -> str:
        ...
        _data = content.find("div", {"class":"about-blog"})
    ...
    def run(self):
        ...
        df = pd.read_csv("24mantra.csv", engine='python')
        ...
        for count, dat in enumerate(df.index):
            ...
            mantra_res = self.sub_24mantra(url = url)
...
if __name__ == '__main__':
    ...
    #Run scraper
    scraper = CombinedPaa_Mantra(max_paa = max_paa, max_divisions = max_divisions)
    scraper.run()