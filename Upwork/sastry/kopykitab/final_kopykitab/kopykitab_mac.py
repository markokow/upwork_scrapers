...
class KopyKitab():
    def __init__(self, book_url: str = '', total_pages: int = 1) -> None:
        ...
        self.driver = webdriver.Chrome(executable_path=r"/Users/rexlopper/Desktop/upwork_scraper/upwork_scrapers/Upwork/sastry/kopykitab/final_kopykitab/chromedriver")
...
if __name__ == "__main__":
    book_url = "https://www.kopykitab.com/index.php?route=pdfviewer/view&product_id=64608"
    total_pages = 13
